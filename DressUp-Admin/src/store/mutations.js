import {RECEIVE_LIST, MOVIES_ARR, OPENID, MYWXINFO, MYCOSINFO, MYLOGININFO} from './mutation-type'
...
export default {
  ...
  [MYCOSINFO](state, data){
	...
	[MYLOGININFO](state, data){
	  state.myLoginInfo = data;
	  console.log("我的登陆信息获取成功");
	}
}
